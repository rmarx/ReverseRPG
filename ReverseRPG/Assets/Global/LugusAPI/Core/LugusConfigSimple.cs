...
// simple version of the config, just a wrapper around PlayerPrefs
// does not support advanced features like multiple user profiles or saving to xml file

public class LugusConfigSimple : MonoBehaviour
{
